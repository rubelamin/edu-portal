...
export default function VideoRow({ videoDetails }) {
  const { title, description, id } = videoDetails || {};
  ...
  return (
    <tr>
      ...
      <td className="table-td">{textExcerpt(description, 6)}</td>
