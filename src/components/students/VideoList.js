...
export default function VideoList({ videoDetails, pushVideoId }) {
  const { title, views, duration, id } = videoDetails || {};
  return (
    <div className="w-full flex flex-row gap-2 cursor-pointer hover:bg-slate-900 p-2">
      ...
      <div clas="flex flex-col w-full" onClick={() => pushVideoId(id)}>
